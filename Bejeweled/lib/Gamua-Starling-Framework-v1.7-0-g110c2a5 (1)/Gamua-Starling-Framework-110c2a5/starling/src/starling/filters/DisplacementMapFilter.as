...
package starling.filters {
	...
	public class DisplacementMapFilter extends FragmentFilter {
		...
		private function updateParameters(textureWidth:int, textureHeight:int):void {
			...
			sMapTexCoords[0] = -mapX;
			sMapTexCoords[1] = -mapY;
			sMapTexCoords[2] = -mapX + maxU;
			sMapTexCoords[3] = -mapY;
			sMapTexCoords[4] = -mapX;
			sMapTexCoords[5] = -mapY + maxV;
			sMapTexCoords[6] = -mapX + maxU;
			sMapTexCoords[7] = -mapY + maxV;
